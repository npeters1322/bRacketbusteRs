...
A bracket function is also in the works. This will allow you to provide your competition submission data (with the matchups and predicted probabilities) to the function. Then, the function will take your predictions and fill in a bracket for you that can be exported to print.
